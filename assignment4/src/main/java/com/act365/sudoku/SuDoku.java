...
public class SuDoku extends Frame
{
    ...
    SuDoku(Grid grid)
    {
        ...
        MenuBar menuBar = new MenuBar();  // jcc
        GridContainer gc = new GridContainer(grid);
        menuBar.add(gc.getFileMenu());    // jcc
        setMenuBar(menuBar);              // jcc
     ...
     * <br><code>boxesAcross</code> is the number of boxes to appear across one row of the Su Doku
     * grid - the default is 3.
     * <br><code>boxesDown</code> is the number of boxes to appear down one column of the Su Doku
     * grid - the default is 3.
